...
This comprehensive educational resource — "Spinning Up in Active Inference" — is modeled on OpenAI's *Spinning Up in RL* and Neuromatch Academy's computational neuroscience curriculum. It takes students from animal behavior foundations through classical RL, into Active Inference and the Free Energy Principle, using our codebase across PGMax-AIF, neuro-nav, and Concordia/SustainHub as the hands-on backbone.
